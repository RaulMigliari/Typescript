...
function addCrewMember(member: string, spaceship: { name: string, crewLimit: number, crew: []}) {
...
function sendInMission(spaceship: {name: string, crewLimit: string, crew: [], inMission: boolean}) {
